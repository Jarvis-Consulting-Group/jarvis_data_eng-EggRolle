...
public class TwitterCLIBean {
  ...
  @Bean
  public Controller controller(TwitterService service)
  {
    return new TwitterController(service);
  }

  @Bean
  public Service service(TwitterDao dao) { return new TwitterService(dao);}

  @Bean
  public CrdDao crdDao(TwitterHttpHelper httpHelper)
  {
